...
export type OwnerManifestBody = Pick<Manifest, "_id" | "_rev"> & {
  maintainers?: any; // or define the proper maintainers type
};

export type UnPublishManifest = Omit<
  Manifest,
  "_attachments" | "_distfiles" | "_uplinks"
>;
